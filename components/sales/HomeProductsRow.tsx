  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        <motion.ul
          variants={itemReveal}
          className="mt-8 flex gap-4 overflow-x-auto pb-2 snap-x snap-mandatory [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:grid sm:grid-cols-2 sm:overflow-visible sm:pb-0 lg:grid-cols-3 lg:gap-5 xl:grid-cols-5"
          dir={dir}
        >
