              ...
              <motion.div key={card.slug} variants={itemReveal}>
                ...
                >
                  <div className="flex items-center gap-3">
                    <TermIcon name={card.slug} plain />
                    <span className={`text-base text-paper/90 ${fa ? "font-fa" : "font-pixel"}`}>{card.title}</span>
                  </div>
                  <p className="mt-4 flex-1 text-sm leading-relaxed text-paper/55">{card.body}</p>
      ...
      >
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {[
              {
                title: ui.links.servicesTitle,
                body: ui.links.servicesBody,
                href: ui.links.servicesHref,
              },
              {
                title: ui.links.portfolioTitle,
                body: ui.links.portfolioBody,
                href: ui.links.portfolioHref,
              },
            ].map((item) => (
