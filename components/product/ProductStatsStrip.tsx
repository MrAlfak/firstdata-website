...
function StatCell({
  ...
  const count = useCountUp(stat.value, { start: active, duration: 750, decimals });
  ...
  return (
    ...
    >
      <p className={`font-mono text-2xl leading-none tabular-nums sm:text-3xl ${accentText}`} dir="ltr">
        {display}
      </p>
...
export default function ProductStatsStrip({
  ...
  return (
    <motion.section
      ...
      className="scroll-mt-24 border-b border-paper/20 bg-paper/[0.02] px-4 py-10 sm:px-6 sm:py-12 lg:px-8"
    >
